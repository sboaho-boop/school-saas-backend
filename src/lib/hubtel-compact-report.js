...
const BASE_URL = 'basic-credit-report-api.mycreditscore.com.gh';
...
function makeRequest({ body, credentials }) {
  ...
  return new Promise((resolve, reject) => {
    const req = https.request({
      hostname: BASE_URL,
      path: '/api/v1/credit-profile-summary',
      method: 'POST',
      headers: {
        'Authorization': auth,
...
async function getCompactReport({
  ghanaCard,
  identifierName,
...
module.exports = { getCompactReport };
